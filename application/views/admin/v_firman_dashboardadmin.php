       ...
       <div class="container-fluid">
           ...
           <!-- Page Heading -->
           <h6 class="h3 mb-0 text-bold text-gray-800">Selamat Datang <?= $petugas['nama_petugas'] ?></h6> <br>
           <div class="row">
               ...
               <div class="col-xl-4 col-md-6 mb-4">
                   <div class="card border-left-warning shadow h-100 py-2">
                       <div class="card-body">
                           <div class="row no-gutters align-items-center">
                               <div class="col mr-2">
                                   <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Selesai
                                   </div>
                                   <div class="row no-gutters align-items-center">
                                       <div class="col-auto">
