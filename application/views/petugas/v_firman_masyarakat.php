                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td><?= $m['telepon']  ?></td>
                                <td><?= $m['is_active']  ?></td>
                                <th><a class="btn btn-danger" href="<?= base_url('C_firman_Update/petugasbanMasyarakat/') . $m['id'] ?>" onclick="return confirm('Apa anda yakin akan ban masyarakat ini?')"><i class="fa fa-ban"></i></a>
                                    <a class="btn btn-primary" href="<?= base_url('C_firman_Update/petugasaktifMasyarakat/') . $m['id'] ?>" onclick="return confirm('Apa anda yakin akan aktivasi masyarakat ini?')"><i class="fa fa-check"></i></a>
                                </th>
                            </tr>
