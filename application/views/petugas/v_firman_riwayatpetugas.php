                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <th>
                                    <?php if ($ra['status'] == '0') : ?>
                                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#ngadu<?= $ra['id_pengaduan'] ?>">
                                            Segera
                                        </button>
                                    <?php endif ?>
                                    <?php if ($ra['status'] == "proses") : ?>
                                        <a type="button" class="btn btn-primary" href="<?= base_url('C_firman_dashboard/proses_petugas/') . $ra['id_pengaduan'] ?>">
                                            Proses
                                        </a>
                                    <?php endif ?>
                                    <?php if ($ra['status'] == "selesai") : ?>
                                        <a type="button" class="btn btn-success" href="<?= base_url('C_firman_dashboard/selesai_petugas/') . $ra['id_pengaduan'] ?>">
                                            Selesai
                                        </a>
                                    <?php endif ?>
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form method="post" action="<?= base_url('C_firman_Update/upload_tanggapan/') . $ra['id_pengaduan'] ?>">
                                                        <fieldset disabled>
                                                            <div class="row">
